...
echo  !cMagenta!   WINDOWS SECURITY FEATURES MANAGER!cReset!
...
call :get_hypervisor_status
if "!hyp_status!"=="1" reg add "HKLM\SOFTWARE\ManageVBS" /v Hypervisor /t REG_DWORD /d 1 /f >nul 2>&1
...
if "!revert_hyp!"=="0x1" (
    ...
    if errorlevel 1 (echo !cRed![FAIL]!cReset! & set "haderror=1") else (echo !cGreen![OK]!cReset! & reg delete "HKLM\SOFTWARE\ManageVBS" /v Hypervisor /f >nul 2>&1)
)
